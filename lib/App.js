    ...
    return (
      <div>
        ...
        <div className="forecastButtons">
          <button className="toggleSevenHourBtn" onClick={this.toggleSevenHour}>7 Hour</button>
          <button className="toggleTenDayBtn" onClick={this.toggleTenDay}>10 Hour</button>
        </div>
        {
